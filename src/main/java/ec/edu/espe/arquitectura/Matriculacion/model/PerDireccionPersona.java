...
public class PerDireccionPersona implements Serializable {
    ...
    private static final long serialVersionUID = 12837897;
    @EmbeddedId
    ...
    public String toString() {
        return "ec.edu.espe.arquitectura.Matriculacion.model.PerDireccionPersona[ perDireccionPersonaPK=" + perDireccionPersonaPK + " ]";
    }
